...
# Setup git defaults:
git config --global user.email "tunght13488@gmail.com"
git config --global user.name "tunght13488"

# Add SSH-based remote to GitHub repo:
git remote add deploy git@github.com:tunght13488/cache-warmer.git
git fetch deploy
...
# file conflicts:
mv cache-warmer.phar cache-warmer.phar.tmp

# Checkout gh-pages and add PHAR file and version:
git checkout -b gh-pages deploy/gh-pages
mv cache-warmer.phar.tmp cache-warmer.phar
sha1sum cache-warmer.phar > cache-warmer.phar.version
git add cache-warmer.phar cache-warmer.phar.version
